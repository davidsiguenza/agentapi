...
const corsOptions = {
  origin: function (origin, callback) {
    ...
    const allowedOrigins = [
      ...
      'https://*.site.com',
      'https://*.force.com',
      'https://*zzse-171.dx.commercecloud.salesforce.com'
    ];
...
const SALESFORCE_TOKEN_URL = process.env.SALESFORCE_TOKEN_URL || "https://storm-92056ec8b1c6ce.my.salesforce.com/services/oauth2/token";
  ...
  try {
    const response = await fetch(SALESFORCE_CHAT_URL, {
      ...
      body: JSON.stringify({
        ...
        instanceConfig: { endpoint: process.env.SALESFORCE_INSTANCE || "https://storm-92056ec8b1c6ce.my.salesforce.com" },
        variables: [],
